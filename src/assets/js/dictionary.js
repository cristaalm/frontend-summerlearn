export default {
  ...
  es: {
    ...
    mission: {
      ...
      description:
        'SummerLearn se compromete a proporcionar educación básica de calidad a niños en comunidades de bajos recursos. Creemos que la educación es un derecho humano fundamental y que cada niño merece la oportunidad de aprender y crecer.',
      values: {
        1: {
