export function usePasswordSecurity({ status, validate, password }) {
    const validatePassword = () => {
      ...
      if (secureLevel > 2) {
        status.value.password.value = true
        status.value.password.error = false
      } else {
        status.value.password.value = false
