...
<template>
  <TransitionRoot appear :show="props.quickSearch" as="template">
    <HeadlessDialog as="div" class="relative z-[60]" @close="props.setQuickSearch">
      <TransitionChild
        as="div"
            ...
            >
              <div class="relative">
                <div class="absolute inset-y-0 left-0 flex items-center justify-center w-12">
                  <Lucide icon="Search" class="w-5 h-5 -mr-1.5 text-slate-500 stroke-[1]" />
                </div>
                <FormInput
              ...
              >
                <template v-if="search.length > 3">
                  <div class="flex flex-col items-center justify-center pt-20 pb-28">
                    ...
                    <div class="w-2/3 mt-3 leading-relaxed text-center text-slate-500">
                  ...
                  <div>
                    <div class="px-5 py-4">
                      ...
                      <div class="flex flex-wrap gap-2 mt-3.5">
                        ...
                        >
                          <Lucide icon="UsersRound" class="w-4 h-4 stroke-[1.3]" />
                          Users
                        </a>
                        <a
                          href=""
                          class="flex items-center gap-x-1.5 border rounded-full px-3 py-0.5 border-slate-300/70 hover:bg-slate-50"
                        >
                          <Lucide icon="Building2" class="w-4 h-4 stroke-[1.3]" />
                          Departments
                        </a>
                        <a
                          href=""
                          class="flex items-center gap-x-1.5 border rounded-full px-3 py-0.5 border-slate-300/70 hover:bg-slate-50"
                        >
                          <Lucide icon="KanbanSquare" class="w-4 h-4 stroke-[1.3]" />
                          Products
                        </a>
                        <a
                          href=""
                          class="flex items-center gap-x-1.5 border rounded-full px-3 py-0.5 border-slate-300/70 hover:bg-slate-50"
                        >
                          <Lucide icon="MailCheck" class="w-4 h-4 stroke-[1.3]" />
                          Mails
                        </a>
                        <Menu>
                          <Menu.Button
                          ...
                          >
                            More
                            <Lucide icon="ChevronDown" class="w-4 h-4 stroke-[1.3] -ml-0.5" />
                          </Menu.Button>
                    ...
                    <div class="px-5 py-4 border-t border-dashed">
                      <div class="flex items-center">
                        ...
                        <a class="ml-auto text-xs text-slate-500" href=""> See All </a>
                      </div>
                    ...
                    <div class="px-5 py-4 border-t border-dashed">
                      ...
                      <div class="flex flex-col gap-1 mt-3.5">
                        <template
                          v-for="(faker, fakerKey) in _.take(departments.fakeDepartments(), 3)"
                          :key="fakerKey"
                        >
                          <a
                            href=""
                    ...
                    <div class="px-5 py-4 border-t border-dashed">
                      <div class="flex items-center">
                        <div class="text-xs uppercase text-slate-500">Products</div>
                        <a class="ml-auto text-xs text-slate-500" href=""> See All </a>
                      </div>
                      <div class="flex flex-col gap-1 mt-3.5">
                        <template
                          v-for="(faker, fakerKey) in _.take(products.fakeProducts(), 3)"
                          :key="fakerKey"
                        >
                          <a
                            href=""
