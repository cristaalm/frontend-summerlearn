...
<template>
  ...
  <div
    :class="`flex flex-col md:flex-row w-full fixed transition-all duration-300 min-h-[80px] bg-opacity-70 backdrop-filter backdrop-blur-sm z-50 ${color || !topScroll ? 'bg-gray-800 md:bg-blued/70' : ''} `">
