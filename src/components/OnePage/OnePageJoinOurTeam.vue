...
<template>
  <div
    class="min-h-screen h-fit w-full py-12 md:py-24 lg:py-32 flex flex-col justify-center items-center space-y-4 bg-gradient-to-r from-hred1 to-hred2"
    id="joinOurTeam">
    <h1 class="text-7xl font-bold text-center mb-10 text-white">{{ $t('joinOurTeam.title') }}</h1>
