...
<template>
  <div class="min-h-screen w-full py-12 md:py-24 lg:py-32 flex flex-col justify-center items-center bg-redd space-y-4 "
    id="joinOurTeam">
        ...
        <div class="container px-4 md:px-6">
          <div class="flex flex-col items-center justify-center space-y-4 text-center">
            <div class="space-y-2">
              ...
              <p class="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed text-justify">
