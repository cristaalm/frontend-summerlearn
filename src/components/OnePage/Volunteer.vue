<template>
    <section id="volunteer"
        className="w-full py-12 md:py-24 lg:py-32 flex flex-col justify-center items-center bg-white" data-aos="fade-up"
        data-aos-delay="100">
        <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                    <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl"> {{ $t('volunteer.title') }}</h2>
                    <p
