  ...
  <div class="col-span-12 md:col-span-4 box box--stacked h-fit" id="activitiesList">
    <div class="flex flex-col gap-5 p-2 leading-relaxed">
      ...
      >
        <Lucide
          icon="BookMarked"
          class="w-5 h-5 mr-2 stroke-[1.3] text-primary dark:text-blue-400"
        />
      ...
      <div class="grid w-full grid-cols-1 gap-5">
        ...
        <template
          v-if="lastActivities.length > 0 && !loadingLastActivities"
          v-for="(activity, index) in lastActivities.slice(0, 4)"
        ...
        >
          ...
          >
            ...
            <div
              class="text-xs text-slate-600 dark:text-slate-400 flex items-center gap-1 truncate"
            >
      ...
      >
        <div
          class="flex flex-row gap-2 justify-center items-center transform scale-100 hover:scale-110 transition-all cursor-pointer text-primary dark:text-blue-400"
