...
const { lastProgramsUnasigned, loadingLastProgramsUnasigned, loadLastProgramsUnasigned, errorLastProgramsUnasigned } = inject('lastProgramsUnasigned');
    ...
    <div class="col-span-12 md:col-span-4 box box--stacked h-fit">
        <div class="flex flex-col gap-5 p-2 leading-relaxed">
            ...
            <div class="grid w-full grid-cols-1 gap-5">
                ...
                <div v-if="loadingLastProgramsUnasigned"
                ...
                <div v-if="lastProgramsUnasigned.length === 0 && !loadingLastProgramsUnasigned"
                ...
                <template v-if="lastProgramsUnasigned.length > 0 && !loadingLastProgramsUnasigned"
                    v-for="(program, index) in lastProgramsUnasigned.slice(0, 5)" :key="program.programs_id">
                    <div
                        class="col-span-1 w-full flex flex-col gap-2 p-3 border-l-4 border-green-400 dark:border-green-600 shadow-md dark:shadow-slate-700/40 bg-slate-100 dark:bg-slate-700/60 text-slate-600 dark:text-slate-300 rounded-md overflow-hidden">
                        ...
                        <div class="text-xs flex items-center gap-1 text-green-600 dark:text-green-400 truncate">
            ...
            <div class="text-slate-400/80 dark:text-slate-200 flex justify-center items-center p-5 rounded-[0.6rem]"
                ...
                <div class="flex flex-row gap-2 justify-center items-center transform scale-100 hover:scale-110 transition-all cursor-pointer text-green-500"
