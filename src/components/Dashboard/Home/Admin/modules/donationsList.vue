...
const { lastDonations, loadingLastDonations, loadLastDonations, errorLastDonations } =
  inject('lastDonations')
  ...
  <div class="flex flex-col col-span-12 lg:col-span-6 gap-y-10">
    <div>
      ...
      <div class="p-5 mt-3.5 box box--stacked" id="donationsList">
        ...
        <div
          v-if="
            !loadingLastDonations &&
            !errorLastDonations &&
            lastDonations?.last_donations?.length === 0
          "
        ...
        <template
          v-if="
            !loadingLastDonations && !errorLastDonations && lastDonations?.last_donations?.length
          "
        >
