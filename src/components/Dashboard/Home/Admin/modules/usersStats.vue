      ...
      >
        ...
        <div class="flex flex-col items-center">
          ...
          >
            <Lucide
              icon="Shield"
              class="w-6 h-6 text-primary fill-primary/10 dark:text-primary"
              v-if="!loadingCountUsers"
            />
            <LoadingIcon
              v-if="loadingCountUsers"
              icon="tail-spin"
              class="stroke-[1.3] w-6 h-6"
              color="black"
            />
            <div
              class="absolute -bottom-2 -right-2 flex items-center justify-center w-5 h-5 text-xs font-medium text-primary dark:text-slate-200 bg-white dark:bg-slate-500 rounded-full"
              v-if="!loadingCountUsers"
            >
        ...
        <div class="flex flex-col items-center">
          ...
          >
            <Lucide
              icon="UserCog"
              class="w-6 h-6 text-info fill-info/10 dark:text-info"
              v-if="!loadingCountUsers"
            />
            <LoadingIcon
              v-if="loadingCountUsers"
            ...
            />
            <div
              class="absolute -bottom-2 -right-2 flex items-center justify-center w-5 h-5 text-xs font-medium text-info dark:text-slate-200 bg-white dark:bg-slate-500 rounded-full"
              v-if="!loadingCountUsers"
            >
        ...
        <div class="flex flex-col items-center">
          ...
          >
            <Lucide
              icon="User"
              class="w-6 h-6 text-success fill-success/10 dark:text-success"
              v-if="!loadingCountUsers"
            />
            <LoadingIcon
              v-if="loadingCountUsers"
            ...
            />
            <div
              class="absolute -bottom-2 -right-2 flex items-center justify-center w-5 h-5 text-xs font-medium text-success dark:text-slate-200 bg-white dark:bg-slate-500 rounded-full"
              v-if="!loadingCountUsers"
            >
              {{ countUsers.Donante }}
            </div>
        ...
        <div class="flex flex-col items-center">
          ...
          >
            <Lucide
              icon="UserCheck"
              class="w-6 h-6 text-warning fill-warning/10 dark:text-warning"
              v-if="!loadingCountUsers"
            />
            <LoadingIcon
              v-if="loadingCountUsers"
            ...
            />
            <div
              class="absolute -bottom-2 -right-2 flex items-center justify-center w-5 h-5 text-xs font-medium text-warning dark:text-slate-200 bg-white dark:bg-slate-500 rounded-full"
              v-if="!loadingCountUsers"
            >
        ...
        <div class="flex flex-col items-center">
          ...
          >
            <Lucide
              icon="Users"
              class="w-6 h-6 fill-secondary/10 text-white dark:text-secondary"
              v-if="!loadingCountUsers"
            />
            <LoadingIcon
              v-if="loadingCountUsers"
            ...
            />
            <div
              class="absolute -bottom-2 -right-2 flex items-center justify-center w-5 h-5 text-xs font-medium text-slate-400 dark:text-slate-200 bg-white dark:bg-slate-500 rounded-full"
              v-if="!loadingCountUsers"
            >
        ...
        <div class="flex flex-col items-center">
          ...
          >
            <Lucide
              icon="UserX"
              class="w-6 h-6 text-danger fill-danger/10 dark:text-danger"
              v-if="!loadingCountUsers"
            />
            <LoadingIcon
              v-if="loadingCountUsers"
            ...
            />
            <div
              class="absolute -bottom-2 -right-2 flex items-center justify-center w-5 h-5 text-xs font-medium text-danger dark:text-slate-200 bg-white dark:bg-slate-500 rounded-full"
              v-if="!loadingCountUsers"
            >
              {{ countUsers.Inactivo }}
            </div>
      ...
      >
        ...
        <div class="text-center md:text-left">
          ...
          <div class="block lg:hidden mt-1 leading-relaxed text-slate-600 dark:text-slate-400">
            {{ loadingCountUsers ? 'Cargando...' : countUsers.Total + ' usuarios registrados.' }}
          </div>
        </div>
        <div class="flex flex-col w-full sm:w-auto sm:flex-row md:ml-auto">
          <Button
            ...
            rounded
            class="w-full xl:w-56 text-blue-500"
            @click="
              () => {
