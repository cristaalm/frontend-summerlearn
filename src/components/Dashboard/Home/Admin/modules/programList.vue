...
const { lastPrograms, loadingLastPrograms, loadLastPrograms, errorLastPrograms } =
  inject('lastPrograms')
    ...
    <div class="flex flex-col gap-y-7">
      <div class="flex flex-col gap-y-6" id="programList">
        <div class="flex flex-col md:h-10 gap-y-3 md:items-center md:flex-row">
          <div
            class="text-base font-medium 2xl:group-[.mode--light]:text-white dark:text-slate-200"
          >
            Programas
          </div>
        </div>
        ...
        <div
          v-if="!loadingLastPrograms && !errorLastPrograms && lastPrograms.length === 0"
        ...
        <div
          class="w-full m-5 cursor-pointer text-blue-500 text-center flex flex-row justify-center items-center hover:scale-105 transition-all"
