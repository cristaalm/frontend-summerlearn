...
watch(() => props.infoProgram, (newVal) => {
    if (newVal) {
...
const handleUpdateProgram = () => {
    updateProgram({ program: props.infoProgram, newProgram: newPogram, setModalEditProgram: props.setModalEditProgram })
}
...
<template>
    ...
    <Dialog size="xl" :open="ModalEditProgram" @close="() => {
            ...
            <div class="flex flex-col">
                <div
                    ...
                    <div
                        ...
                        <div class="flex-1 w-full mt-3">
                            <FormInput v-model="nameProgram" class="flex-1 mt-2 dark:text-slate-200"
                    ...
                    <div
                        ...
                        <label class="mb-0 text-right mr-14 w-2/4">
                            <div class="text-left">
                                <div class="flex items-center">
                                    <div class="font-medium text-black dark:text-slate-200 ">Responsable del programa
                                    </div>
                                </div>
                                <div
                                    class="mt-1.5 xl:mt-3 text-xs leading-relaxed text-slate-500/80 dark:text-slate-400">
                    ...
                    <div
                        ...
                        <label class="mb-0 text-right mr-14 w-2/4">
                            <div class="text-left">
                                <div class="flex items-center">
                                    <div class="font-medium text-black dark:text-slate-200 ">Escolaridad del programa
                                    </div>
                                </div>
                                <div
                                    class="mt-1.5 xl:mt-3 text-xs leading-relaxed text-slate-500/80 dark:text-slate-400">
                        ...
                        <div class=" w-2/6 mt-3 xl:mt-0">
                            <FormSelect v-model="selectedGrade" class="flex-1 mt-2 dark:text-slate-200"
                                @keydown.enter.prevent="() => {
                                    if (valid && !loadingEditProgram) handleUpdateProgram()
                                }">
                    ...
                    <div
                        ...
                        <label class="mb-0 text-right mr-14 w-2/4">
                            <div class="text-left">
                                <div class="flex items-center">
                                    <div class="font-medium text-black dark:text-slate-200 ">Área del programa
                                    </div>
                                </div>
                                <div
                                    class="mt-1.5 xl:mt-3 text-xs leading-relaxed text-slate-500/80 dark:text-slate-400">
                        ...
                        <div class=" w-2/6 mt-3 xl:mt-0">
                            <FormSelect v-model="selectedArea" class="flex-1 mt-2 dark:text-slate-200"
                                @keydown.enter.prevent="() => {
                                    if (valid && !loadingEditProgram) handleUpdateProgram()
                                }">
                    ...
                    <div
                        ...
                        <label class="mb-0 text-right mr-14 w-2/4">
                            <div class="text-left">
                                <div class="flex items-center">
                                    <div class="font-medium text-black dark:text-slate-200 ">Duración del programa
                                    </div>
                                </div>
                                <div
                                    class="mt-1.5 xl:mt-3 text-xs leading-relaxed text-slate-500/80 dark:text-slate-400">
                        ...
                        <div class=" w-2/6 mt-3 xl:mt-0">
                            <Litepicker v-model="durationProgram" :options="{
                                autoApply: false,
                                singleMode: false,
                                numberOfColumns: 2,
                                numberOfMonths: 2,
                ...
                <div class="flex py-5 md:justify-end px-7">
                    <Button variant="outline-success" class="w-full px-10 md:w-auto dark:text-slate-200"
                        @click="handleUpdateProgram" :disabled="loadingEditProgram || !valid">
                        <Lucide v-if="!loadingEditProgram" icon="Save"
                            class="stroke-[1.3] w-4 h-4 mr-2 -ml-2 text-success dark:text-slate-200" />
                        <LoadingIcon v-if="loadingEditProgram" icon="tail-spin" class="stroke-[1.3] w-4 h-4 mr-2 -ml-2"
                            color="black" />
