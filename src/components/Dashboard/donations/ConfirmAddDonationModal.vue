...
const handleConfirm = () => {
    ...
    <!-- BEGIN: Modal Content -->
    <Dialog size="lg" :open="ModalConfirmAddDonation" @close="() => {
        ...
        <Dialog.Panel>
            <div class="p-5 text-center">
                ...
                <div class="w-16 h-16 mx-auto mt-3">
                    <Lucide v-if="!setDonationLoading" icon="CheckCircle" class="w-full h-full text-success" />
            ...
            <div class="px-5 pb-8 text-center space-x-8">
                <Button type="button" variant="outline-danger" @click="setModalConfirmAddDonation({ open: false })"
                    class="w-24 mr-1 dark:text-slate-200">
                    Cancelar
                </Button>
                <Button type="button" variant="outline-success" class="w-24 dark:text-slate-200" @click="handleConfirm"
                    ref="deleteButtonRef">
                    Confirmar
                </Button>
            </div>
