    ...
    <div class="h-[530px] gap-1 flex flex-col">
        ...
        >
          ...
          <div class="flex-[0.8] min-w-0">
            ...
            <div class="flex items-center mt-1.5">
              <div
                class="text-slate-500/90 dark:text-slate-400 truncate max-w-full md:max-w-[12rem]"
              >
                {{ contact.user.rol }}
              </div>
            </div>
          ...
          <div class="relative flex gap-2 flex-[0.1]">
            <Tippy
              as="button"
              @click="() => sendEmail(contact.user.email)"
      ...
      <template v-else>
        <div class="flex items-center justify-center h-[530px]">
          <div class="text-slate dark:text-slate-400">No se encontraron resultados</div>
        </div>
      </template>
    </div>
  </template>
