...
const { loadingMail, errorMail, warningMail, successMail, messageMail, sendMail } = useSendMail({
  email
})
const router = useRouter()
const alertVariant = computed(() => {
  return successMail.value
    ? 'soft-success'
    : errorMail.value
      ? 'soft-danger'
      : warningMail.value
          ...
          <div class="mt-6">
            ...
            <div class="mt-5 text-center xl:mt-8 xl:text-left">
              <Button
                ...
                variant="primary"
                rounded
                :disabled="loadingMail || !statusMail.value"
        ...
        <div class="mt-10 text-center">
          ...
          <div class="mt-4 text-slate-600 dark:text-slate-400 flex flex-col gap-2">
            ...
            <p class="text-lg">
              ...
              <span class="font-medium dark:text-slate-200">{{ email }}</span> con un enlace para
