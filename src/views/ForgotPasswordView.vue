    ...
    <div :class="[
      ...
      <div class="relative z-10 flex flex-col justify-center w-full h-full py-2 lg:py-32">
        ...
        <div class="mt-10">
          ...
          <Alert variant="outline-danger" v-if="error == 'Correo no encontrado'"
          ...
          <div class="mt-6">
            ...
            <div class="mt-5 text-center xl:mt-8 xl:text-left">
              <Button @click="handleSendMail" variant="primary" rounded :disabled="!status"
    ...
    <div :class="[
      ...
      <div class="sticky top-0 z-10 flex-col justify-center hidden h-screen ml-16 lg:flex xl:ml-28 2xl:ml-36">
        ...
        <div class="mt-5 text-base leading-relaxed xl:text-lg text-white/70">
          No te preocupes, estamos aquí para ayudarte a restablecer tu cuenta.
          Sigue los pasos para volver a formar parte de nuestra comunidad de voluntarios y continuar apoyando nuestra
          misión.
        </div>
      </div>
    </div>
