          ...
          <div class="mt-6">
            ...
            <div class="mt-5 text-center xl:mt-8 xl:text-left">
              <Button @click="() => {
                ...
                :class="`bg-gradient-to-r transition-all border-none scale-105 duration-200 w-full py-3.5 xl:mr-3 ${valid && !loading && (loginSuccess == '') ? 'from-green-dark to-green hover:scale-100 select-none cursor-pointer' : 'from-gray-600 to-gray-600 cursor-default'}`">
