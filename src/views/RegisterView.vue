      ...
      <div class="relative z-10 flex flex-col justify-center w-full h-full py-2">
        ...
        <div class="mt-10">
          ...
          <div class="mt-6">
            ...
            <div class="flex flex-row text-red-600 p-2" v-if="status.firstName.menssage">{{ status.firstName.menssage }}
            </div>
            ...
            <div class="flex flex-row text-red-600 p-2" v-if="status.lastName.menssage">{{ status.lastName.menssage }}
            </div>
            ...
            <div class="flex flex-row text-red-600 p-2" v-if="status.birthdate.menssage">{{ status.birthdate.menssage }}
            </div>
            ...
            <FormInput type="password" name="password" data-context="Contraseña"
              ...
              placeholder="************" v-model="password" @input="(e) => {
                ...
                " />
            <div class="flex flex-row text-red-600 p-2" v-if="status.password.menssage">{{ status.password.menssage }}
            </div>
            ...
            <div class="flex flex-row text-red-600 p-2" v-if="status.password_confirm.menssage">{{
              status.password_confirm.menssage }}</div>
    ...
    <div :class="[
      ...
      <div class="sticky top-0 z-10 flex-col justify-center hidden h-screen ml-16 lg:flex xl:ml-28 2xl:ml-36">
        ...
        <div class="mt-5 text-base leading-relaxed xl:text-lg text-white/70">
          ...
          estructurados y visualmente impresionantes con módulos ricos en funciones. Únete hoy para dar forma al futuro
          del desarrollo de tu aplicación.
        </div>
      </div>
    </div>
  </div>
