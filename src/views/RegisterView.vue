...
<template>
          ...
          <div class="mt-6">
            ...
            >
              ...
              <label class="cursor-pointer select-none dark:text-slate-200" htmlFor="terms">
                Acepto los
                <a
                  class="ml-1 text-primary dark:text-slate-400 dark:hover:text-blue-500"
                  href="/terms"
                  target="_blank"
                >
            ...
            <div class="mt-2.5 text-black dark:text-slate-200 mb-5">
              ...
              <span
                class="font-medium text-primary cursor-pointer dark:text-slate-400 dark:hover:text-blue-500"
      ...
      <div class="relative z-10 flex flex-col justify-center w-full h-full py-2" v-else>
        <div class="mt-10 text-center">
          ...
          <div class="mt-4 text-slate-600 dark:text-slate-400 flex flex-col gap-2">
            ...
            <p class="text-lg">Tendrás acceso a tu perfil con algunas limitaciones.</p>
            <p class="text-lg">Espera a que un administrador valide tu cuenta.</p>
          </div>
          <div class="mt-6">
            <button
              @click="router.push({ name: 'login' })"
  ...
  >
    ...
    >
      <DynamicText
        class="hidden lg:sticky"
        :phrases="phrases[route.params.rol]"
