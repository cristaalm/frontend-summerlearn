...
import {
  ...
  usePasswordSecurity,
  useUpdatePassword
} from '@/hooks/settings/changePassword'
...
const { validate, validatePasswordCurrent, validateNewPasswordComfirm } = useValidateFunctions({
  valid,
...
const { loadingUpdatePassword, updatePassword } = useUpdatePassword({
  newPassword,
  newPasswordConfirm,
  currentPassword,
  validate,
  ...
  <div class="flex flex-col p-5 box box--stacked">
        ...
        <div class="flex-1 w-full mt-3 xl:mt-0">
          ...
          >
            ...
            <ul v-if="status.new_password.secure != 4">
              <li
                v-for="item in status.new_password.list"
                :key="item"
    ...
    <div class="flex pt-5 mt-6 border-t border-dashed md:justify-end border-slate-300/70">
      <Button
        ...
        :disabled="!valid || loadingUpdatePassword"
