            ...
            <div class="mt-7">
                <div class="flex flex-col box box--stacked">
                    <div class="p-7">
                        ...
                        <Alert variant="outline-danger" v-if="setProgramError"
                        ...
                        <div class="flex-col block pt-5 mt-5 xl:items-center sm:flex xl:flex-row first:mt-0 first:pt-0">
                            ...
                            <div class="flex-1 w-full mt-3 xl:mt-0">
                                <FormInput type="text" placeholder="Escriba aqui el nombre del programa..."
                                    v-model="name" />
                    ...
                    <div class="flex py-5 border-t md:justify-end px-7 border-slate-200/80">
                        <Button
                            ...
                            <LoadingIcon v-if="setProgramLoading" icon="tail-spin"
