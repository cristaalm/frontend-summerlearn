...
const {
  ...
  removeImage,
  imageFile
} = useValidationImage({ status, validateAll })
const { setChildrenError, setChildrenLoading, addChildren } = useSetChildren({
  name,
  birthdate,
  curp,
  grade,
        ...
        <div class="flex flex-col box box--stacked">
          <div class="p-7">
            ...
            <Alert
              ...
              v-if="setChildrenError"
              :message="setChildrenError"
              :dismissible="true"
            ...
            >
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <FormInput
                  type="text"
                  placeholder="Escriba aquí el nombre del niño/a..."
                  v-model="name"
            ...
            >
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <FormInput
                  type="text"
                  placeholder="Escriba aquí la CURP del niño/a..."
                  v-model="curp"
                  @keydown.enter.prevent="
                    () => {
                      if (valid && !setChildrenLoading) handleRegister()
          ...
          >
            <Button
              ...
              :disabled="!valid || setChildrenLoading"
            >
              <LoadingIcon
                v-if="setChildrenLoading"
                icon="tail-spin"
