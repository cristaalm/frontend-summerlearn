          ...
          <div class="p-7">
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <div class="flex items-center">
                  ...
                  <Button
                    ...
                    size="sm"
                    class="pl-3.5 pr-4 mr-2 h-8 ml-8 dark:border-red-400 dark:text-red-400"
                    @click="removeImage"
                  >
            ...
            >
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                ...
                <div
                  class="text-red-500 mt-2 dark:text-red-400 flex flex-col items-center md:flex-row"
                >
            ...
            >
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                ...
                <div class="text-red-500 mt-2 dark:text-red-400">
                  {{ status.birthdate.message }}
                </div>
              </div>
            </div>
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                ...
                <div :class="`mt-2 ${status.password.error ? 'text-red-500' : 'text-blue-600'}`">
                  ...
                  <ul v-if="status.password.secure != 4">
                    <li
                      v-for="item in status.password.list"
                      :key="item"
            ...
            >
              <label class="inline-block mb-2 sm:mb-0 sm:mr-5 sm:text-right xl:w-60 xl:mr-14">
                <div class="text-left">
                  <div class="flex items-center">
                    <div class="font-medium text-nowrap dark:text-slate-200">
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <InputGroup class="mt-2">
                  <FormInput
                    placeholder="Escriba nuevamente aquí su contraseña..."
                    @keydown.enter.prevent="
                      () => {
                        if (valid && !loading) addUser()
                      }
                ...
                <div class="text-red-500 mt-2 dark:text-red-400">
                  {{ status.password_confirm.message }}
                </div>
              </div>
            </div>
          </div>
          <div
            class="flex py-5 border-t md:justify-end px-7 border-slate-200/80 dark:border-slate-400"
          >
            <Button
