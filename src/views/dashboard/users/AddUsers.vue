  ...
  const { firstName, lastName, email, phone, birthdate, password, password_confirm, rol, valid, showPassword, showPasswordConfirm } = useRefs();
  const { validateText, validateDate, validatePasswordComfirm, validateInputPhone, validateRol, validate } = useValidateFunctions({ valid, password, password_confirm, status });
  ...
  const { loading, addUser } = useSetUser({ email, phone, password, firstName, lastName, birthdate, rol, imageFile, valid, validate, resetFields });
          ...
          <div class="flex flex-col box box--stacked">
            <div class="p-7">
                ...
                <div class="flex-1 w-full mt-3 xl:mt-0">
                  <div class="flex items-center">
                    <div
                      ...
                      <input id="profileImageInput" type="file" class="hidden" @change="validateImage"
                        accept="image/*" />
                    </div>
              ...
              <div class="flex-col block pt-5 mt-5 xl:items-center sm:flex xl:flex-row first:mt-0 first:pt-0">
                ...
                <div class="flex-1 w-full mt-3 xl:mt-0">
                  ...
                  <div class="text-red-500 mt-2 flex flex-col items-center md:flex-row">
                    ...
                    <div v-if="status.lastName.error" class="text-xs w-full md:w-1/2">{{ status.lastName.message }}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="flex-col block pt-5 mt-5 xl:items-center sm:flex xl:flex-row first:mt-0 first:pt-0">
                ...
                <div class="flex-1 w-full mt-3 xl:mt-0">
                  <FormInput type="text" placeholder="Escriba aquí su teléfono celular..." name="phone" v-model="phone"
                    @input="(e) => {
                ...
                <div class="flex-1 w-full mt-3 xl:mt-0">
                  <InputGroup class="mt-2">
                    <FormInput :type="`${showPassword ? 'text' : 'password'}`"
                      placeholder="Escriba aquí su contraseña..." name="password" v-model="password" @input="(e) => {
                        validatePassword(e)
                        validatePasswordComfirm(e)
                      }" />
                    <InputGroup.Text @click="() => { showPassword = !showPassword }" class="cursor-pointer">
                      <button>
