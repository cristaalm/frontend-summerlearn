...
const { validationConfirmPassword, validate } = useValidation({
  password,
  confirm_password,
  status,
  valid
...
const { loadingPassword, errorPassword, successPassword, messagePassword, changePassword } =
  useChangePassword()
...
<template>
      ...
      >
        <div class="mt-10 dark:text-slate-200">
          ...
          <div class="mt-6">
            ...
            <FormLabel class="mt-4"
              >Nueva contraseña <span class="text-red-600 bold">*</span></FormLabel
            >
            <InputGroup class="mt-2">
              <FormInput
                :type="`${showPassword ? 'text' : 'password'}`"
                placeholder="**********"
                class="block px-4 py-3.5 border-slate-300/80"
                name="password"
                v-model="password"
              />
              <InputGroup.Text
            ...
            <FormLabel class="mt-4"
              >Confirmar contraseña <span class="text-red-600 bold">*</span></FormLabel
            >
            <InputGroup class="mt-2">
              <FormInput
            ...
            <div class="mt-5 text-center xl:mt-8 xl:text-left">
              <Button
                ...
                "
                :disabled="!valid || loadingPassword"
                variant="primary"
                rounded
      ...
      <div class="relative z-10 flex flex-col justify-center w-full h-full py-2 lg:py-32" v-else>
        <div class="mt-10 text-center">
          ...
          <div class="mt-4 text-slate-600 dark:text-slate-400 flex flex-col gap-2">
            ...
            <p class="text-lg">Tu contraseña ha sido actualizada correctamente.</p>
            <p class="text-lg">Ahora puedes cerrar esta ventana.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  >
    ...
    >
      ...
      <br />
      <div
        class="hidden xl:ml-[115px] 2xl:ml-[140px] lg:block absolute lg:ml-[70px] bottom-40 text-white"
      >
